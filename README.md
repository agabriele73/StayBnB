...
![Alt text](Screenshot%202023-01-31%20215708.png)
...
* Request
  * Method: POST
  * URL: /api/:userId/:reviewId/images
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: DELETE
  * URL: /api/:userId/:reviewId/:imageId
  * Body: none
