        ...
        <div className="spots-container">
            {spots.map(spot => (
                ...
                <div className="spot-card"  data-spot-name={spot.name}>
                        ...
                        {isNaN(spot.avgRating) ? <div className="stars-container"><p className="fa-solid fa-star"></p>New</div> : <div className="stars-container"><p className='fa-solid fa-star'></p>{spot.avgRating}</div>}
